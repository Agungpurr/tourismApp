...
import 'package:tourism_app/provider/detail/tourism_detail_state.dart';
    ...
    return Scaffold(
            ...
            ChangeNotifierProvider(
              ...
              child: Consumer<TourismDetailProvider>(
                ...
                return switch (value.resultState) {
                  TourismDetailLoadedState(place: var tourism) =>
        ...
        body: Consumer<TourismDetailProvider>(builder: (context, value, child) {
          return switch (value.resultState) {
            ...
            TourismDetailErrorState(message: var message) => Center(
                child: Text(message),
              ),
            _ => const SizedBox(),
          };
